...
ADMINS_TO_ACCESS_REPORTS = ['suman@atai.ai','srinivas.mallipudi@soctronics.com', 'PrabhakaraRao.Aravapalli@invecas.com','kp@soctronics.com']
SUB_ADMINS_TO_ACCESS_REPORTS = ['trinath@atai.ai']
STAGED_EMPLOYEE_INFO_EMAILS=['suman@atai.ai','dipak@atai.ai']
MIS_REPORT_RECEIVER_EMAILS =['suman@atai.ai','srinivas.mallipudi@soctronics.com', 'PrabhakaraRao.Aravapalli@invecas.com','kp@soctronics.com']
